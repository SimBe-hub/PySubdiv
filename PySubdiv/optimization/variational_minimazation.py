        ...
        while epsilon > epsilon_0 and iteration < number_iteration:
            ...
            if len(self.variable_edges) == 0 or skip_csv is True:
                ...
                if len(self.variable_edges) == 0:
                    ...
                    cost, result_h = optimizer.optimize(objective_functions.objective_h_swarm, iterations_swarm,
                                                        n_processes=2,
                                                        mesh=self.control_mesh, v=self.v,
                    ...
                    self.control_mesh.set_crease(minimized_creases, self.variable_edges)
