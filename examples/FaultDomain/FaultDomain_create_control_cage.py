...
control_cage = control_cage.create_control_cage(original_meshes, simple_subdivision=True,
                                                iteration_subdivision=2)
print(control_cage.data['dynamic_faces'])
# when the control cage is created we want to save the mesh and the dictionary of the meshes property to we can restore
# it later
